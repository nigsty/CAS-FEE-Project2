...
* "npm install"
* "npm start"
* Die Webseite ist unter [http://localhost:3000/](http://localhost:3000/)  oder auf dem Web (Firebase deploy) unter [Habescha's Web page](https://habescha-fee.web.app "Habescha's WebPage") erreichbar.
